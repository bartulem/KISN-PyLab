...
class read:
    ...
    def readSE(self, **kwargs):
        ...
        **kwargs: dictionary
        ...
        syncChan = int([kwargs['syncChan'] if 'syncChan' in kwargs.keys() and type(kwargs['syncChan']) == int or type(kwargs['syncChan']) == float else 385][0])
        ...
        syncData = npxRecording[syncChan - 1, :]
